...
void display_registers(Emulator *emu)
{
  ...
  sprintf(full,
      ...
      cyan, c_flag, decor_col, value_col, get_carry(cpu),
      ...
      cyan, z_flag, decor_col, value_col, get_zero_flag(cpu),
      ...
      cyan, n_flag, decor_col, value_col, get_negative_flag(cpu),
      ...
      cyan, v_flag, decor_col, value_col, get_overflow_flag(cpu));
